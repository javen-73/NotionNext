...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '晚天长，秋水苍，山腰落日，烟霞掩斜阳🌇, 烟霞问讯，⾵月相知🌙, 迷失的人迷失了，相逢的人再相逢👣',
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Javen73 BLOG', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
        process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || 'Javen73的Blog 博客, 喜欢记录和分享一些技术和diy改造文章, Javen73, 博客, Java, Python, 机器学习, 深度学习, Nginx, 网络,diy自制', // 站点描述，被notion中的页面描述覆盖
